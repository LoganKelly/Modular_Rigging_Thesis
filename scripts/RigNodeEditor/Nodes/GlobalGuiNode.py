# GlobalGuiNode extends the BaseNode class
...
class GlobalGuiNode(BaseNode,QtSvg.QGraphicsSvgItem):
    ...
    def mousePressEvent(self, event):
        super(GlobalGuiNode, self).mousePressEvent(event)
    ...
    def paint(self, painter, option, widget):
        ...
        super(GlobalGuiNode, self).paint(painter, option, widget)
    ...
    def getXMLStart(self):
        return "Global XML Started, metaNodeName = "+self.metaNodeName+", rigId = "+self.rigId
    
    def getXMLEnd(self):
        return "Global XML Ended"
